    ...
    public function run(): void
    {
        $scripts = [
            [
                ...
                'content_rud' => "Assalam-o-Alaikum! Main Tika Dost hoon — Pakistan ke vaccinators aur Lady Health Workers ke liye EPI training assistant. Aap mujh se vaccines, cold chain, aur immunization sessions ke baare mein koi bhi sawaal pooch sakte hain.",
