...
جواب کا انداز:
- سادہ زبان میں۔ ٹیکنیکل اصطلاحات کی وضاحت کریں۔
- جواب مکمل ہو: CONTEXT میں موجود تمام متعلقہ تفصیل شامل کریں — عام طور پر 3 سے 6 جملے۔ ایک جملے کا ادھورا جواب نہ دیں۔
...
ځواب باید:
- بشپړ خو ساده وي — معمولاً ۳ تر ۶ جملې، د CONTEXT ټول اړوند جزئیات پکې وي
...
جواب هجڻ گهرجي:
- مڪمل پر سادو — عام طور تي 3 کان 6 جملا، CONTEXT جا سڀ لاڳاپيل تفصيل شامل هجن
...
پاسخ باید:
- کامل اما ساده باشد — معمولاً ۳ تا ۶ جمله، با همه جزئیات مرتبط از CONTEXT
